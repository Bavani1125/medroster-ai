    ...
    <Container maxWidth="lg" sx={{ py: 4 }}>
      ...
      <Box sx={{ mb: 4 }}>
        <Box sx={{ display: 'flex', alignItems: 'center', gap: 2, mb: 2 }}>
          ...
          <Chip
            label={ROLE_LABELS[(user?.role as any) || 'staff'] || user?.role}
            sx={{
              bgcolor: getRoleBgColor((user?.role as any) || 'staff'),
              color: getRoleColor((user?.role as any) || 'staff'),
              fontWeight: 'bold',
            }}
          />
        </Box>
          ...
          {dialogType === 'department' ? (
            ...
            <>
              ...
              <TextField
                ...
                onChange={(e) =>
                  setNewShift({ ...newShift, department_id: parseInt(e.target.value) })
                }
                SelectProps={{
                  native: true,
                }}
              ...
              <TextField
                ...
                onChange={(e) =>
                  setNewShift({ ...newShift, required_staff_count: parseInt(e.target.value) })
                }
              />
              <Box sx={{ display: 'flex', gap: 1, mt: 3 }}>
                <Button variant="outlined" onClick={() => setOpenDialog(false)}>
